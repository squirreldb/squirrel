...
SERVER_SRC := squirrel_server.cc
CLIENT_SRC := squirrel_client.cc
DUMMY_DB_SRC := dummy_db.cc

SERVER_OBJ := $(SERVER_SRC:.cc=.o)
CLIENT_OBJ := $(CLIENT_SRC:.cc=.o)
DUMMY_DB_OBJ := $(DUMMY_DB_SRC:.cc=.o)
...
squirrel_server: $(PROTO_OBJ) $(SERVER_OBJ) $(DUMMY_DB_OBJ)
